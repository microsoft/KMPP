...
sudo apt-get update  
sudo apt-get install -y pkg-config cmake curl libcurl4-openssl-dev libglib2.0-dev libgtest-dev libdbus-1-dev uuid-dev libssl-dev build-essential googletest libtss2-dev libjansson4  
