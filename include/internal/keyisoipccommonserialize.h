...
typedef enum {
    ...
    SerializeStatus_OutOfMemory,     // cbor encoder has received not too small memory allocation
    SerializeStatus_InternalError,   // internal cbor library error
    SerializeStatus_InvalidFormat,   // format received is not as expected
...
#define SIZE_MULTIPLE_TO_ALLOC_OUT_STRUCT 5
