...
/////////////////////////////////////////////////////
/*
This function contains a temporary implementation copied from SymCrypt code
TODO: The implementation will be changed to use SymCrypt methods directly when they are ready to be consumed from SymCrypt
*/
VOID
SYMCRYPT_CALL
                                            ...
                                            SIZE_T* pcbResult)
{
    ...
    __attribute__((unused)) UINT32  cbSrc32; // To avoid unused var warning, a sensitive code copied from SymCrypt.
    UINT32  cbDst32;
    UINT32  cbMsg32;
    ...
    for (SIZE_T i = 0; i < cbBlockSize; ++i)  // cbDst <= cbSrc == cbBlockSize
    {
...
/*
End of temporary implementation copied from SymCrypt code
The implementation will be changed to use SymCrypt methods directly when they are ready to be consumed from SymCrypt
*/