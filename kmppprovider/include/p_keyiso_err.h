 ...
 */
 ...
 typedef enum {
    ...
    KeyIsoErrReason_FailedToImport,
    KeyIsoErrReason_FailedToExport,
    KeyIsoErrReason_FailedToInitProvider,
    KeyIsoErrReason_FailedToGetBio,
    ...
    KeyIsoErrReason_FailedToGetKeyType,
    KeyIsoErrReason_FailedToGetKeyCtx,
    KeyIsoErrReason_FailedToGetProvKey,
    KeyIsoErrReason_FailedToLoadProvKey,
    KeyIsoErrReason_FailedToGetUri,
    KeyIsoErrReason_FailedToSetParams,
    KeyIsoErrReason_FailedToGenerateKey,
    KeyIsoErrReason_FailedToCreatePfx,
    KeyIsoErrReason_FailedToCreateCert,
    KeyIsoErrReason_FailedToEncodePem,
    KeyIsoErrReason_FailedToDecodePem,
    KeyIsoErrReason_FailedToFormatKeyId,
    KeyIsoErrReason_UnsupportedType,
    KeyIsoErrReason_UnsupportedSelection,
    KeyIsoErrReason_FailedToSetKeyAttributes,
    KeyIsoErrReason_FailedToGetConf,
    KeyIsoErrReason_FailedToEditAltNamesSection,
    KeyIsoErrReason_FailedToDeriveInit,
    KeyIsoErrReason_FailedToSetDerivedKeyPeer,
    KeyIsoErrReason_FailedToDeriveKey,
    ...
    KeyIsoErrReason_UnsupportedNumberOfPrimes,
    KeyIsoErrReason_UnsupportedFormat,
    KeyIsoErrReason_UnsupportedKeyType,
    KeyIsoErrReason_UnsupportedCurve,
    KeyIsoErrReason_InvalidStoreCtx,
    KeyIsoErrReason_InvalidMsgDigest,
    KeyIsoErrReason_InvalidParams,
    KeyIsoErrReason_InvalidKeySize,
    KeyIsoErrReason_InvalidKeyId,
    KeyIsoErrReason_InvalidLength,
    KeyIsoErrReason_InvalidCurve,
    KeyIsoErrReason_HeaderNotFound,
    KeyIsoErrReason_InvalidSignatureLength,
    KeyIsoErrReason_FailedEncodingPublicKey,
    KeyIsoErrReason_FailedToLoadKeyForKeysInUse,
    KeyIsoErrReason_MaxError
} KeyIsoErrReason;